...
library name: moonshine-voice, FunASR, sherpa-onnx, Supertonic, Piper TTS, stream2sentence, Silero VAD, webrtcvad-wheels, and sounddevice
...
pyproject dependency: supertonic

declared dependency: supertonic==1.3.1
